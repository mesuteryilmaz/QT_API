...
namespace MBO_Market_Data_Analytics.LegacyV1
{
    ...
    public class DataAnalyticsIndicator : Indicator
    {
        ...
        {
            Name = "MBP Market Data Analytics (V1)";
            Description = "Legacy V1 microstructure analytics panel for CME Futures (dxFeed MBP/MBO). Kept alongside the V2 analytics indicator.";
